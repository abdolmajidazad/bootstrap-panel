        ...
        $stateProvider
            .state('root', {
                ...
                views: {
                    ...
                    // "body@" : {},
                    "header@root": {
                        templateUrl: 'views/tpl/header/header.html?@@timeStampVersion',
                        controller: 'headerController'
                    },
                    "footer@root": {
                        templateUrl: 'views/tpl/footer/footer.html?@@timeStampVersion',
                        controller: 'footerController'
                    },
                    "rightSidebar@root": {
                        templateUrl: 'views/tpl/sidebar/right/sidebar.html?@@timeStampVersion',
                        controller: 'rightSidebarController'
                    },
                    "leftSidebar@root": {
                        templateUrl: 'views/tpl/sidebar/left/sidebar.html?@@timeStampVersion',
            ...
            .state('root.myDrive', {
                ...
                views: {
                    "afterLogin": {
                        templateUrl: "views/pages/myDrive/myDrive.html?@@timeStampVersion",
                ...
                resolve:
                    {
                        deps: function ($q, $rootScope) {
                            let deferred = $q.defer();
                            let dependencies = appIncludeFilesJson[appEnvironment].pages.myDrive.js;
                            $script(dependencies, function () {
                                $rootScope.$apply(function () {
                                    deferred.resolve();
                                });
            ...
            .state('root.recent', {
                ...
                views: {
                    "afterLogin": {
                        templateUrl: "views/pages/recent/recent.html?@@timeStampVersion",
                ...
                resolve:
                    {
                        deps: function ($q, $rootScope) {
                            let deferred = $q.defer();
                            let dependencies = appIncludeFilesJson[appEnvironment].pages.recent.js;
                            $script(dependencies, function () {
                                $rootScope.$apply(function () {
                                    deferred.resolve();
                                });
            ...
            .state('root.signin', {
                ...
                views: {
                    "beforeLogin": {
                        templateUrl: "views/pages/signin/signin.html?@@timeStampVersion",
                ...
                resolve:
                    {
                        deps: function ($q, $rootScope) {
                            let deferred = $q.defer();
                            let dependencies = appIncludeFilesJson[appEnvironment].pages.signin.js;
            ...
            .state('root.notFound', {
                ...
                views: {
                    "beforeLogin": {
                        templateUrl: "views/pages/404/404.html?@@timeStampVersion",
...
myApp.run(["$rootScope", "$state", "$stateParams", "$urlRouter", "$location", "$filter", "$window", "appService", '$timeout', 'loader', function ($rootScope, $state, $stateParams, $urlRouter, $location, $filter, $window, appService, $timeout, loader) {
    ...
    $rootScope.$on('$locationChangeSuccess', function (e, newUrl, oldUrl) {
         ...
         */
        const newUrlName = newUrl.split('/').slice(-1)[0];
        const oldUrlName = oldUrl.split('/').slice(-1)[0];
        ...
        if ($rootScope.generalData && $rootScope.generalData['jhoobinJhubData']) {
            ...
            appService.getAccountData().then(() => {
